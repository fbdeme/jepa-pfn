...
from ._base import RandomTensorTransformer, Context
from ._activation import RandomActivation
from ._matrix import RandomMatrix, RandomGaussianMatrix
...
class RandomTreeFunction(RandomFunction):
    ...
    """
    def _fit(self, x: torch.Tensor):
        from ._points import RandomGaussianPoints
